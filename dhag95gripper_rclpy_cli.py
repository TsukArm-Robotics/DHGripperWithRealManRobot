#!/usr/bin/env python3
"""
dhag95gripper_rclpy_cli.py

目的
  - RM65 の末端 RS485 に接続された DH Robotics AG95 グリッパーを、
...
使い方（例）
  ...
  - ON の直後に OFF もしたい場合（初期化だけしたくない運用）
      python3 dhag95gripper_rclpy_cli.py on --close-after-on
